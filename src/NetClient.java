...
// используем данный код вместо других приложение типа пути, данный код формирует черное окошко
// определенных размеров, чтоб можно было вводить текст и получать (типа консоли)
